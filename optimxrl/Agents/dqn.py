...
from optimxrl.Models.dqn_model import DQNModel
...
class DQNAgent:
    def __init__(
        ...
        LOUT.f = nn.f_iden
        self.onlineNet = DQNModel([A1, AOUT], no_bias=self.no_bias)
        self.targetNet = DQNModel([L1, LOUT], no_bias=self.no_bias)
        self.model_params = {
            "w0": A1.w,
            "w1": AOUT.w,
            "m10": A1.m1,
